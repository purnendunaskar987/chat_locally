...
def listen_for_messages(client, username):
    ...
    # Find the client in active_clients and remove them
    ...
    left_message = "SERVER~" + f"{username} has left the chat"
    send_messages_to_all(left_message)
    client.close()
...
def send_messages_to_all(message):
    ...
    for user in active_clients:
        try:
            ...
            print(f"Failed to send message to {user[0]}. Removing client.")
